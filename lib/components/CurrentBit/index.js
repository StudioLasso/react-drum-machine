...
var CurrentBitContainer = _wrapComponent('CurrentBitContainer')(function (_Component) {
	_inherits(CurrentBitContainer, _Component);

	function CurrentBitContainer(props) {
		_classCallCheck(this, CurrentBitContainer);

		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CurrentBitContainer).call(this, props));
	...
	_createClass(CurrentBitContainer, [{
		...
		value: function render() {
			return _react3.default.createElement(_CurrentBit2.default, {
